                        ...
                        <form action="" id="form1" method="POST" enctype="multipart/form-data">
                            <div class="row mt-5 align-items-center">
                                ...
                                <div class="col">
                                    <div class="row align-items-center">
                                        <div class="col-md-7">
                                            <h4 class="mb-1" id="displayname"><?php echo $abcd['ad_fullname']; ?></h4>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" id="firstname" name="ad_fullname" value="<?php echo $abcd['ad_fullname'];  ?>" class="form-control" placeholder="Enter valid name">
                                </div>
