...
<div class="main-slider main-slider-2">
    <div class="slider-pro" id="main-slider" data-slider-width="100%" data-slider-height="700px" data-slider-arrows="true" data-slider-buttons="false">
        <div class="sp-slides">
            <!-- Slide 1-->
            <div class="sp-slide">
                <img class="sp-image" src="assets/images/sliders/Banner-Generator.jpg" alt="slider" />
                <div class="main-slider__wrap sp-layer" data-width="40%" data-position="centerLeft" data-horizontal="0" data-show-transition="left" data-hide-transition="left" data-show-duration="2000" data-show-delay="1200" data-hide-delay="400">
                    <div class="main-slider__title">Generator<span class="text-primary">7</span>series<span class="main-slider__label">model 2018</span>
                    </div>
                    <div class="main-slider__price"><span class="main-slider__price-currency">Rs</span><span class="main-slider__price-number">375</span><span class="main-slider__price-inner"><span class="main-slider__price-title"> at total</span><span class="main-slider__price-subtitle">Lowest Markup</span></span>
                    </div>
                    <a class="main-slider__btn btn btn-lg btn-primary" href="services.html">learn more</a>
                </div>
            </div>
            <!-- Slide 2-->
            <div class="sp-slide">
                <img class="sp-image" src="assets/images/sliders/Banner-Online-UPS.jpg" alt="slider" />
                <div class="main-slider__wrap sp-layer" data-width="40%" data-position="centerLeft" data-horizontal="0" data-show-transition="left" data-hide-transition="left" data-show-duration="2000" data-show-delay="1200" data-hide-delay="400">
                    <div class="main-slider__title">Online UPS<span class="text-primary">7</span>series<span class="main-slider__label">model 2018</span>
                    </div>
        ...
        <div class="col-md-12">
            <div class="section-advantages-1">
                <section class="b-advantages-1"><i class="b-advantages-1__icon flaticon-gearbox"></i>
                    <h3 class="b-advantages-1__title">Largest Dealership</h3>
                    <div class="b-advantages-1__info">Crystal Power is nisi aliquip ex consequat duis velit esse cillum dolore fugiat nulla pariatur excepteur sint occaecat.</div><span class="ui-decor-2"></span>
                </section>
                <!-- end .b-advantages-->
                <section class="b-advantages-1 active">
                    ...
                    <h3 class="b-advantages-1__title">We Offers Lower Product Prices</h3>
                    <div class="b-advantages-1__info">Crystal Power is nisi aliquip ex consequat duis velit esse cillum dolore fugiat nulla pariatur excepteur sint occaecat.</div><span class="ui-decor-2"></span>
                </section>
                <!-- end .b-advantages-->
                <section class="b-advantages-1"><i class="b-advantages-1__icon flaticon-wrench"></i>
                    <h3 class="b-advantages-1__title">Guarantee on products</h3>
                    <div class="b-advantages-1__info">Crystal Power is nisi aliquip ex consequat duis velit esse cillum dolore fugiat nulla pariatur excepteur sint occaecat.</div><span class="ui-decor-2"></span>
                </section>
                <!-- end .b-advantages-->
            </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="text-center">
                    <h2 class="ui-title-block">Find Your Products</h2>
                    <div class="ui-subtitle-block">You can search for your products</div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <input type="text" name="sp_name" class="form-control" placeholder="Enter product name">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <select class="selectpicker form-control" data-width="100%">
                            ...
                            <?php
                            $abc = $pdo->prepare("SELECT * FROM category");
                            $abc->execute();
                            foreach ($abc as $abc2) {
                                echo '<option>' . $abc2['c_name'] . '</option>';
                            }
                            ?>
                        </select>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="b-filter__btns">
                            <button class="btn btn-lg btn-primary">Search</button><a class="btn-link" href="#">ADVANCED SEARCH</a>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="section-default">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="text-center">
                    ...
                    <div class="ui-subtitle-block">You can find your featured products</div>
                    <div class="ui-decor"></div>
                </div>
            </div>
        </div>
    ...
    <div class="featured-carousel owl-carousel owl-theme owl-theme_w-btn enable-owl-carousel" data-min768="2" data-min992="3" data-min1200="5" data-margin="30" data-pagination="false" data-navigation="true" data-auto-play="4000" data-stop-on-hover="true">
        <?php
        $rr = $pdo->prepare("SELECT * FROM featured_products fp
        INNER JOIN products p ON p.p_id=fp.fp_p_id");
        $rr->execute();
        foreach ($rr as $rr2) {
            echo '<div class="b-goods-feat">
            <div class="b-goods-feat__img">
                <img class="img-responsive" src="assets/images/inventory/' . $rr2['p_image1'] . '" alt="foto" /><span class="b-goods-feat__label">Rs. ' . $rr2['p_price'] . '</span>
            </div>
            <ul class="b-goods-feat__desc list-unstyled">
                <li class="b-goods-feat__desc-item">ID: ' . $rr2['p_code'] . '</li>
                <li class="b-goods-feat__desc-item">Model: 2017</li>
                <li class="b-goods-feat__desc-item">Size: ' . $rr2['p_size'] . '</li>
            </ul>
            <h3 class="b-goods-feat__name"><a href="car-details.htm">' . $rr2['p_name'] . '</a></h3>
            <div class="b-goods-feat__info">' . strip_tags($rr2['p_desc']) . '</div>
        </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <section class="b-advantages-2"><i class="b-advantages-2__icon flaticon-wheel-alignment"></i>
                        <h3 class="b-advantages-2__title">Highly<strong>Reliable</strong></h3>
                        <div class="b-advantages-2__info">Crystal Power is nisi aliquip ex con velit esse cillum dolore fugiatal excepteur sint occaecat.</div><span class="ui-decor-2"></span>
                    </section>
                    <!-- end .b-advantages-->
                </div>
                <div class="col-md-3">
                    <section class="b-advantages-2"><i class="b-advantages-2__icon flaticon-gearstick"></i>
                        <h3 class="b-advantages-2__title">Best in class<strong>Fuel Efficiency</strong></h3>
                        <div class="b-advantages-2__info">Crystal Power is nisi aliquip ex con velit esse cillum dolore fugiatal excepteur sint occaecat.</div><span class="ui-decor-2"></span>
                    </section>
                    <!-- end .b-advantages-->
                </div>
                <div class="col-md-3">
                    <section class="b-advantages-2"><i class="b-advantages-2__icon flaticon-painting"></i>
                        <h3 class="b-advantages-2__title">Superior<strong>Performance</strong></h3>
                        <div class="b-advantages-2__info">Crystal Power is nisi aliquip ex con velit esse cillum dolore fugiatal excepteur sint occaecat.</div><span class="ui-decor-2"></span>
                    </section>
                    <!-- end .b-advantages-->
                </div>
                <div class="col-md-3">
                    <section class="b-advantages-2"><i class="b-advantages-2__icon flaticon-inspection"></i>
                        <h3 class="b-advantages-2__title">Lower<strong>Maintainence Cost</strong></h3>
                        <div class="b-advantages-2__info">Crystal Power is nisi aliquip ex con velit esse cillum dolore fugiatal excepteur sint occaecat.</div><span class="ui-decor-2"></span>
                    </section>
                    <!-- end .b-advantages-->
                </div>
...
<div class="info-group block-table block-table_md">
    <div class="info-group__section col-md-6">
        <section class="b-info b-info_mod-a area-bg area-bg_op_80 area-bg_prim parallax" style="background-image: url(assets/media/content/bg/bg-4.jpg)">
            <div class="area-bg__inner">
                <h2 class="b-info__title">Are You Looking<strong class="b-info__title_lg">TO BUY A PRODUCT?</strong></h2>
                <div class="b-info__desc">Crystal Power is nisi aliquip exa con velit esse cillum dolore fugiatal sint occaecat excepteur ipsum dolor sit amet consectetur.</div><a class="btn btn-white" href="#">search your product</a>
            </div>
        </section>
    </div>
    <div class="info-group__section col-md-6">
        <section class="b-info b-info_mod-b area-bg area-bg_op_80 area-bg_dark-2 parallax" style="background-image: url(assets/media/content/bg/bg-3.jpg)">
            <div class="area-bg__inner">
                <h2 class="b-info__title">Do You Want To<strong class="b-info__title_lg">SELL YOUR PRODUCT?</strong></h2>
                <div class="b-info__desc">Crystal Power is nisi aliquip exa con velit esse cillum dolore fugiatal sint occaecat excepteur ipsum dolor sit amet consectetur.</div><a class="btn btn-white" href="#">let us know</a>
            </div>
        </section>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="text-center">
                    ...
                    <div class="ui-subtitle-block">All the latest news appears here</div>
                    <div class="ui-decor"></div>
                </div>
