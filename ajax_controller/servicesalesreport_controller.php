...
<?php
        ...
        $output = '<div class="container-fluid">
              <div class="row justify-content-center">
                ...
                <div class="col-12">
                  <h2 class="mb-2 page-title">Service Sales Report</h2>
        ...
        LEFT JOIN admins a ON a.ad_id=s.s_uploaded_by WHERE s.s_salestype='s'  && s.s_uploaded_on LIKE '" . $daily . "%'");
        $dta->execute();
        $data = $dta->fetchAll();
        foreach ($data as $dat) {
        ...
        $dta = $pdo->prepare("SELECT * FROM sales s
    LEFT JOIN admins a ON a.ad_id=s.s_uploaded_by WHERE s.s_salestype='s'  && s.s_uploaded_on LIKE '" . $monthly . "%'");
        $dta->execute();
        $data = $dta->fetchAll();
        foreach ($data as $dat) {
        ...
        $dta = $pdo->prepare("SELECT * FROM sales s
    LEFT JOIN admins a ON a.ad_id=s.s_uploaded_by WHERE s.s_salestype='s'  && s.s_uploaded_on LIKE '" . $yearly . "%'");
        $dta->execute();
        $data = $dta->fetchAll();
        foreach ($data as $dat) {
